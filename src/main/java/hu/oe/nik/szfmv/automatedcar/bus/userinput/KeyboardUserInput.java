...
public class KeyboardUserInput implements IUserInput, KeyListener {
    ...
    private void onUnsupportedType(String name) {
        throw new UnsupportedOperationException("There isn't event handling support for this pedal type: " + name);
    }
}