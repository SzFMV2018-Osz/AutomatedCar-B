...
public class KeyboardUserInputTest {
    ...
    @Test
    public void testPedalHandlerSubscription_GasAndBrake() {
        KeyboardUserInput kui = new KeyboardUserInput();

        kui.subscribePedalEvents(new PedalHandlerDummy(), PedalType.Gas);
        kui.subscribePedalEvents(new PedalHandlerDummy(), PedalType.Brake);

        Assert.assertEquals(1, kui.getGasPedalEventHandlers().size());
        Assert.assertEquals(1, kui.getBrakePedalEventHandlers().size());
    }
    ...
    @Test
    public void testShiftingHandling_P() {
    ...
    @Test
    public void testShiftingHandling_N() {
        ShiftingHandlerFake fake = new ShiftingHandlerFake();
        KeyboardUserInput kui = new KeyboardUserInput();
        kui.subscribeShiftingEvents(fake);
        Component dummy = new Component() {
        ...
        int keyCode = ConfigProvider.provide().getLong("keyboard.gear_n").intValue();
        KeyEvent e = new KeyEvent(dummy, 0, new Date().getTime(), 0, keyCode, KeyEvent.CHAR_UNDEFINED);
        ...
        Assert.assertEquals(1, fake.getCounter());
        Assert.assertSame(fake.getGear(), Gear.N);
    }

    @Test
    public void testShiftingHandling_D() {
        ShiftingHandlerFake fake = new ShiftingHandlerFake();
        KeyboardUserInput kui = new KeyboardUserInput();
        kui.subscribeShiftingEvents(fake);
        Component dummy = new Component() {
        ...
        int keyCode = ConfigProvider.provide().getLong("keyboard.gear_d").intValue();
        KeyEvent e = new KeyEvent(dummy, 0, new Date().getTime(), 0, keyCode, KeyEvent.CHAR_UNDEFINED);
        ...
        Assert.assertEquals(1, fake.getCounter());
        Assert.assertSame(fake.getGear(), Gear.D);
    }
    ...
    public void testShiftingHandling() {
        ...
        int keyCode = ConfigProvider.provide().getLong("keyboard.gear_r").intValue();
        KeyEvent e = new KeyEvent(dummy, 0, new Date().getTime(), 0, keyCode, KeyEvent.CHAR_UNDEFINED);
        ...
        Assert.assertEquals(1, fake.getCounter());
        Assert.assertSame(fake.getGear(), Gear.R);
    }
    ...
    @Test
    public void testKeyPressed_Brake() {
        KeyboardUserInput kui = new KeyboardUserInput();
        HandlerFake hf = new HandlerFake();
        kui.subscribePedalEvents(hf, PedalType.Brake);
        Component dummy = new Component() {
            @Override
            public String getName() {
                return super.getName();
        ...
        int keyCode = ConfigProvider.provide().getLong("keyboard.brake").intValue();
        KeyEvent e = new KeyEvent(dummy, 0, new Date().getTime(), 0, keyCode, KeyEvent.CHAR_UNDEFINED);
    ...
    @Test
    public void testKeyReleased_Brake() {
        KeyboardUserInput kui = new KeyboardUserInput();
        HandlerFake hf = new HandlerFake();
        kui.subscribePedalEvents(hf, PedalType.Brake);
        Component dummy = new Component() {
