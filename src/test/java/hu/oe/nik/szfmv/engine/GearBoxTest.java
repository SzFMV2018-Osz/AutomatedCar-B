...
public class GearBoxTest {
    ...
    public void testDriveTransmissionModeHandlerDriveToReserveNotNullRPM() throws Exception {
        // GIVEN
        FieldSetter.setField(underTest, underTest.getClass().getDeclaredField("transmissionModes"),
                TransmissionModes.Drive);
        // WHEN
        try {
            underTest.changeTransmissionMode(TransmissionModes.Reverse, 10);
            Assert.assertTrue(false);
        } catch (final TransmissionModeChangeException e) {
